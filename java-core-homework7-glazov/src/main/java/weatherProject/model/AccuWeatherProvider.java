...
import weatherProject.CurrentWeatherResponse;
import weatherProject.FiveDaysWeatherResponse;
import weatherProject.Temperature;
...
//        System.out.println("5 days forecast fiveDaysResponse-JSON:\n" + fiveDaysResponse.body().string());
        ...
        for (int i = 0; i < fiveDaysResponseJava.getDailyForecasts().length; i++) {
            ...
            System.out.println();
            System.out.println("В городе " + cityName + " на дату " + fiveDaysResponseJava.getDailyForecasts()[i].getDate().substring(0, 10) + " ожидается");
